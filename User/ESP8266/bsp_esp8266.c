...
static void ESP8266_GPIO_Config ( void )
{
	...
	GPIO_InitStructure.GPIO_Pin = macESP8266_CH_PD_PIN;	//pb8
	...
	GPIO_InitStructure.GPIO_Pin = macESP8266_RST_PIN;	//pb9
...
static void ESP8266_USART_Config ( void )
{
	...
	GPIO_InitStructure.GPIO_Pin =  macESP8266_USART_TX_PIN;//pb10
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;//复用推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(macESP8266_USART_TX_PORT, &GPIO_InitStructure);  
  
	/* Configure USART Rx as input floating */
	GPIO_InitStructure.GPIO_Pin = macESP8266_USART_RX_PIN;//pb11
...
bool ESP8266_AT_Test ( void )
{
	...
	macESP8266_RST_HIGH_LEVEL();	
  printf("\r\nATtest.....\r\n");
	ILI9341_DispStringLine_EN_CH(LINE(3),"AT test.....");
	
	Delay_ms ( 2000 );
	while ( count < 10 )
	{
    printf("\r\nAT test time %d......\r\n", count);
		ILI9341_DispStringLine_EN_CH(LINE(4),"AT test time");
				
		if( ESP8266_Cmd ( "AT", "OK", NULL, 500 ) )
    {
      printf("\r\nAT test start up success %d......\r\n", count);
			ILI9341_DispStringLine_EN_CH(LINE(5),"AT  OK");
      return 1;
    }
		ESP8266_Rst();
		++ count;
...
bool ESP8266_DHCP_CUR ( )
{
	...
	ILI9341_DispStringLine_EN_CH(LINE(7),"AT+CWDHCP_CUR=1");
